    ...
    public class IntegracaoAcesso
    {
        ...
        public static List<View.AcessoLogin2> Login(string email, string password)
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                string query = "SELECT Cliente, Nome, Fac_Mor, Fac_Tel, CDU_Sexo, CDU_Password, CDU_Email, Moeda, NumContrib FROM Clientes WHERE CDU_Email = '" + email + "' AND CDU_Password = '" + pass + "'";
                ...
                while (!objList.NoFim())
                {
                    lista.Add(new View.AcessoLogin2
                    {
                        ...
                        contacto = objList.Valor("Fac_Tel"),
            ...
            try
            {
                if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
                {
                    ...
                    */
                    ...
                    chave.AddCampoChave("Cliente", registo.CodCliente);
                    cmp1.Nome = "CDU_Email";
                    cmp1.Valor = registo.email;
                    cmp2.Nome = "CDU_Sexo";
                    cmp2.Valor = registo.sexo;
                    ...
                    PriEngine.Engine.Comercial.Clientes.ActualizaValorAtributos(registo.CodCliente, campos);
                    ...
                    objCli.set_Telefone(registo.contacto);
