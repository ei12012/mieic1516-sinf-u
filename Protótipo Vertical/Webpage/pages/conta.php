   ...
   <div class="col-sm-4">
      <div class="panel panel-default">
         ...
         <ul class="list-group">
            ...
            <li class="list-group-item">
               <a href="<?php echo $BASE_URL;?>pages/editarPalavraChave.php">Editar palavra-chave</a>
            </li>
         </ul>
      </div>
   </div>
      ...
      <div class="panel panel-default">
         <ul class="list-group">
            <li class="list-group-item">
               ...
               <p class="list-group-item-text"><?php echo $cliente["nome"];?></p>
            </li>
            <li class="list-group-item">
               <h4 class="list-group-item-heading">NIF</h4>
               <p class="list-group-item-text"><?php echo $cliente["nif"];?></p>
            </li>
            <li class="list-group-item">
