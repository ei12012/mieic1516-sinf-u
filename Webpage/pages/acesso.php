...
<div class="row">
      ...
      <form role="form" id="formEntrar" action="<?php echo $BASE_URL;?>action/acesso_login.php">
         ...
         <div class="form-group row">
            <div class="col-sm-4">
               ...
               <input type="submit" id="entrar" class="btn btn-default btn-block" value="Entrar"/>
            </div>
         </div>
   ...
   <div class="col-sm-6">
      <form role="form" id="formRegistar" action="<?php echo $BASE_URL;?>action/acesso_registar.php" method="post">
         ...
         <div class="form-group">
            ...
            <div class="radio">
               <label class="radio-inline">
                  <input type="radio" name="Masculino" checked>
                     Masculino
                  </input>
               </label>
               <label class="radio-inline">
         ...
         <div class="row">
            <div class="col-sm-4">
               <input type="submit" id="registar" class="btn btn-default btn-block" value="Registar"/>
            </div>
         </div>
      </form>
   </div>
...
<script src="<?php echo $BASE_URL;?>javascript/acesso.js"></script>
