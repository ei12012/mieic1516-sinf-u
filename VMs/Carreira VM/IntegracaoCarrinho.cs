...
namespace FirstREST.Lib_Primavera.Integration
{
    ...
    {
        public static List<Join.CarrinhoPagamento>ListarCarrinho(string codcliente)
        {
            StdBELista objList;
            List<Join.CarrinhoPagamento> lista = new List<Join.CarrinhoPagamento>();
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                while (!objList.NoFim())
                {
                    lista.Add(new Join.CarrinhoPagamento
                    {
                        cliente=codcliente,
